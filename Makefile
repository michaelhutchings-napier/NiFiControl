...
helm-template: helm-crds-check
	...
	$(HELM) template svc-net $(HELM_CLUSTER_CHART) --namespace dataflows --set-json 'service={"type":"LoadBalancer","port":8080,"nodePort":0,"annotations":{},"ipFamilies":["IPv4","IPv6"],"ipFamilyPolicy":"PreferDualStack","sessionAffinity":"ClientIP","sessionAffinityConfig":{"clientIP":{"timeoutSeconds":10800}}}' --set-json 'externalServices=[{"name":"ext","type":"LoadBalancer","ports":[{"name":"web","port":8080,"targetPort":"web"}],"ipFamilyPolicy":"PreferDualStack","sessionAffinity":"ClientIP"}]' >/dev/null
...
.PHONY: integration-clusterports-kind
